...
const bottleRecordSchema = z.object({
  ...
  bottlerKind: z.enum(BOTTLER_KIND_VALUES).optional(),
  whiskyType: z.enum(WHISKY_TYPE_VALUES).optional(),
  ...
  peatLevel: z.enum(PEAT_LEVEL_VALUES).optional(),
  caskInfluence: z.enum(CASK_INFLUENCE_VALUES).optional(),
